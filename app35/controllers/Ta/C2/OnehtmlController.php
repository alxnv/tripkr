...
class Ta_C2_OneHtmlController extends My_Ta_HEdit2CommonController {
    ...
    public function indexAction() {
        ...
        $row = my3::qobj("SELECT count(*) as cnt from $this->treetbl a,$this->tbl b
        ...
        do {
            $page--;
            $lm=$page*$this->cnt;
            $this->view->arr=my3::qlist("SELECT a.uid,a.ordr,a.topid,a.naim,b.html,b.html2 FROM $this->treetbl a,$this->tbl b 
