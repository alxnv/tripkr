 ...
 */
$testing=0; // если 1, то тестовая отправка всех сообщений на alxnv@yandex.ru

$testemails=array('alxnv@outlook.com','alxnbv@gmail.com','alxnbv@rambler.ru'); // на эти email посылаются сообщения
    // при тесте 
    // на рамблер не отправляется, наверное спам фильтр
